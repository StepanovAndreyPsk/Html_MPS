...
public class ImgTag_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    tgs.append("<img");
    tgs.append(" src = \"");
    tgs.append(SPropertyOperations.getString(ctx.getPrimaryInput(), PROPS.src$y8j3));
    tgs.append("\"");
    if (isNotEmptyString(SPropertyOperations.getString(ctx.getPrimaryInput(), PROPS.alt$hWbB))) {
      tgs.append(" alt = \"");
      tgs.append(SPropertyOperations.getString(ctx.getPrimaryInput(), PROPS.alt$hWbB));
      tgs.append("\"");
    }
