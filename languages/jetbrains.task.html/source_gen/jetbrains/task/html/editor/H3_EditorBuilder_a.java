...
/*package*/ class H3_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public H3_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_i16xtc_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Header 3");
    editorCell.setCellId("Constant_i16xtc_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_i16xtc_b0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_i16xtc_a1a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_i16xtc_c0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_i16xtc_a2a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createCollection_3() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_i16xtc_d0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_i16xtc_a3a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createCollection_4() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_i16xtc_e0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_i16xtc_a4a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_3() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.content$hCoE;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private EditorCell createConstant_5() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_i16xtc_f0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty content$hCoE = MetaAdapterFactory.getProperty(0xe3ef414942a74e42L, 0x8bc2f96cb576bf56L, 0x12fdec7bd2f7ace2L, 0x12fdec7bd2f7ace3L, "content");
  }
